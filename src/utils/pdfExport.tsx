...
import type { ThemeResearchResult, Persona } from '../types';
...
const styles = StyleSheet.create({
  page: { padding: 40, fontFamily: 'Helvetica', fontSize: 10, color: colors.darkGray },
  header: { marginBottom: 20, borderBottomWidth: 3, borderBottomColor: colors.red, paddingBottom: 15 },
  companyName: { fontSize: 24, fontFamily: 'Helvetica-Bold', color: colors.darkGray, marginBottom: 4 },
  companyMeta: { flexDirection: 'row', gap: 12, alignItems: 'center' },
  ticker: { backgroundColor: colors.darkGray, color: colors.white, paddingVertical: 2, paddingHorizontal: 6, borderRadius: 2, fontSize: 9, fontFamily: 'Helvetica-Bold' },
  industry: { color: colors.mediumGray, fontSize: 10 },
  section: { marginBottom: 16 },
  sectionTitle: { fontSize: 11, fontFamily: 'Helvetica-Bold', color: colors.red, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
  summary: { fontSize: 10, lineHeight: 1.5, color: colors.darkGray },
  insightRow: { flexDirection: 'row', marginBottom: 4 },
  insightArrow: { color: colors.red, marginRight: 6, fontSize: 10 },
  insightText: { flex: 1, fontSize: 9, lineHeight: 1.4 },
  themeContainer: { marginBottom: 12, backgroundColor: colors.background, padding: 10, borderRadius: 4, borderLeftWidth: 3, borderLeftColor: colors.red },
  themeHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 },
  themeName: { fontSize: 11, fontFamily: 'Helvetica-Bold', color: colors.darkGray },
  themeScore: { fontSize: 9, color: colors.white, backgroundColor: colors.red, paddingVertical: 2, paddingHorizontal: 6, borderRadius: 2 },
  subSectionTitle: { fontSize: 9, fontFamily: 'Helvetica-Bold', color: colors.mediumGray, marginTop: 6, marginBottom: 3 },
  bulletList: { paddingLeft: 8 },
  bulletItem: { flexDirection: 'row', marginBottom: 2 },
  bullet: { color: colors.red, marginRight: 4, fontSize: 9 },
  bulletText: { flex: 1, fontSize: 9, lineHeight: 1.4 },
  evidenceText: { fontSize: 8, color: colors.mediumGray, fontStyle: 'italic', marginBottom: 2 },
  questionText: { fontSize: 9, fontStyle: 'italic', color: colors.darkGray, marginBottom: 2 },
  competitiveBox: { backgroundColor: colors.background, padding: 10, borderRadius: 4 },
  competitiveText: { fontSize: 9, lineHeight: 1.4 },
  footer: { position: 'absolute', bottom: 30, left: 40, right: 40, flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: colors.lightGray, paddingTop: 10 },
  footerText: { fontSize: 8, color: colors.lightGray },
  personaBadge: { fontSize: 8, color: colors.white, backgroundColor: colors.mediumGray, paddingVertical: 2, paddingHorizontal: 6, borderRadius: 2, marginLeft: 8 },
});
...
interface ResearchPDFProps {
  research: ThemeResearchResult;
  persona: Persona | null;
}

const ResearchPDF = ({ research, persona }: ResearchPDFProps) => {
  const topThemes = Object.entries(research.themeFindings || {})
    .filter(([, findings]) => findings && findings.relevanceScore > 0)
...
export const generatePDF = async (research: ThemeResearchResult, persona: Persona | null = null) => {
